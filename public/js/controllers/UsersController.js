(function() {
    ...
    app.controller('UsersController', ['$scope', '$routeParams', 'UserService', 'UserFactory', '$anchorScroll', '$timeout', function($scope, $routeParams, UserService, UserFactory, $anchorScroll, $timeout) {
