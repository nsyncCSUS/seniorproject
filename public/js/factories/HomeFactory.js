(function() {
	...
	app.factory('HomeFactory', [ function() {
		...
		var factory = {};
		factory.searchText = {text: ""};
		factory.category = {users: true, groups: true, events: true};
		factory.interestFilters = {animals: false, education: false, environment: false, people: false, recreation: false, technology: false, youth: false};
